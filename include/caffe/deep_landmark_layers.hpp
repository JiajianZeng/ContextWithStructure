...
template <typename Dtype>
class ChannelExpandLayer : public Layer<Dtype> {
 public:
  explicit ChannelExpandLayer(const LayerParameter& param)
      : Layer<Dtype>(param){}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
                          const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type(){return "ChannelExpand";}
...
template <typename Dtype>
class FacialLandmarkPerformanceLayer: public Layer<Dtype> {
 public:
  explicit FacialLandmarkPerformanceLayer(const LayerParameter& param)
      : Layer<Dtype>(param){}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
                          const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() {return "FacialLandmarkPerformance";}
  virtual inline int MinBottomBlobs() const {return 3;}
